...
import { HourlyScenarioDetails } from './HourlyScenarioDetails';

interface HourlyResultsTableProps {
    results: HourlyScenarioResult[];
}

export const HourlyResultsTable: React.FC<HourlyResultsTableProps> = ({ results }) => {
