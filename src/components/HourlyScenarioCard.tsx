...
export const HourlyScenarioCard: React.FC<HourlyScenarioCardProps> = ({ scenario, onChange }) => {
    return (
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 flex flex-col gap-4 relative">
            ...
            {/* Linha 1: Valor por Hora + Horas por Dia */}
            ...
            {/* Linha 2: Dias por Semana + Semanas no Mês */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input
                        ...
                        className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 outline-none"
                    />
                    <p className="text-xs text-gray-400">Padrão: 4,345</p>
                </div>
            </div>

            {/* Linha 3: Entrada R$ + Entrada % */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <CurrencyInput
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <p className="text-xs text-gray-400">R$ tem prioridade</p>
                </div>
            </div>

            {/* Linha 4: Data 1ª Parcela + Parcelas Semanais */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1">
